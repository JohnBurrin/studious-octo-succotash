...
return array(
    ...
    'bootstrap4' => array(
        ...
        'previous-link'   => "<a class=\"page-link\" href=\"{uri}\" aria-label=\"Previous\">{page}</a>",
        ...
        'previous-inactive-link' => "<a class=\"page-link\" href=\"#\" aria-label=\"Previous\">{page}</a>",
        ...
        'active-link' => "<a class=\"page-link\" href=\"#\">{page} <span class=\"sr-only\">(current)</span></a>",
        ...
        'next-link'   => "<a class=\"page-link\" href=\"{uri}\" aria-label=\"Next\">{page}</a>",
        ...
        'next-inactive'      => "\n\t\t<li class=\"page-item disabled\">{link}</li>",
        'next-inactive-link' => "<a class=\"page-link\" href=\"#\" aria-label=\"Next\">{page}</a>",
